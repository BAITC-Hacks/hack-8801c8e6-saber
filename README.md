...
- Фронтенд: ванильные HTML/CSS/JS, без сборки, без npm, без фреймворков
...
Проверено **197 Python-тестов и 19 тестов фронтенда**. Для фронтенд-тестов нужен Node.js 22+, без npm-пакетов:
