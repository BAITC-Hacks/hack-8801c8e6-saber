...
Дополнительно: три цели оптимизации с наглядным сравнением, закрепление важных решений, объяснение формулы Score, отмена изменений и локальное сохранение черновика. Фронтенд работает без CDN и сборки.
