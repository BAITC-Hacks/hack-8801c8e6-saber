...
![Реальная карта Астаны: районы и показатели учебной модели](docs/screenshots/map-desktop.png)
...
flowchart LR
    ...
    Browser --> Map["Leaflet + локальный GeoJSON\nГраницы и цвета районов"]
    Map -->|тайлы видимой области| OSM["OpenStreetMap\nПодложка улиц"]
